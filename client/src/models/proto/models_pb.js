...
proto.NoteSequence.toObject = function(includeInstance, msg) {
  var f, obj = {
    lengthList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * @return {!Array<number>}
 */
proto.NoteSequence.prototype.getLengthList = function() {
 ...
 */
proto.NoteSequence.prototype.setLengthList = function(value) {
 ...
 * @return {!proto.NoteSequence} returns this
 */
proto.NoteSequence.prototype.addLength = function(value, opt_index) {
 ...
 * @return {!proto.NoteSequence} returns this
 */
proto.NoteSequence.prototype.clearLengthList = function() {
